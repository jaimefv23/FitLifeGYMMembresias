...
public class PantallaMenuAdmin extends javax.swing.JFrame {
    ...
    /**
     * Creates new form PantallaMenuAdmin
     */
    public PantallaMenuAdmin(ControlMembresias control) {
    ...
    private void initComponents() {
        ...
        textAreaInstalaciones.setFont(new java.awt.Font("Segoe UI", 1, 48)); // NOI18N
        textAreaInstalaciones.setForeground(new java.awt.Color(255, 255, 255));
        textAreaInstalaciones.setRows(5);
        textAreaInstalaciones.setText("MENU ADMINISTRATIVO");
        ...
        btnAmbienteMusical.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAmbienteMusicalActionPerformed(evt);
            }
        });
        ...
        btnBeneficios.setBackground(new java.awt.Color(44, 44, 44));
            ...
            .addGroup(jPanelLayout.createSequentialGroup()
                .addGroup(jPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btnBeneficios, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanelLayout.createSequentialGroup()
                        .addContainerGap()
